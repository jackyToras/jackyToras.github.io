...
profile:
  ...
  image_circular: true
  more_info: >
    <style>.profile img { width: 280px !important; max-width: 280px !important; }</style>
    <div style="margin: 6px 0;"><i class="fas fa-map-marker-alt"></i> Raipur, Chhattisgarh, India</div>
