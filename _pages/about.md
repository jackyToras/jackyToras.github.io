...
<div class="flex flex-col md:flex-row md:space-x-8 items-start">
  ...
  <div class="md:w-2/3">
    ...
    <p>
      A pre-final year B.Tech Computer Science student at Jaypee University of Information Technology, Solan.
    </p>
    ...
    <p>
      <strong>Won 3rd Position (Innovation Award)</strong> at Cyber AI Hackathon 2025 — University of Derby, UK, supported by American Society for Engineers, USA. Team Cyra (T-009) among 100+ teams.
      <a href="/assets/pdf/cyberai-hackathon-2025.pdf" target="_blank">Certificate</a>
    </p>
  </div>
</div>
